...
key = int(input('Masukkan key (dalam angka): '))
...
print('ENKRIPSI',key, '   :', kalimat_hasil)
...
# Pengenkripisian kembali oleh Affine Chiper
print(' ')
print('------------Step 2 Affine Chiper------------')
print(' ')
if __name__ == "__main__": 
  string = "ZBJJLZZPZUVAMPUHSMHPSBYLPZUVAMHAHSPZPAAOLJVBYHNLAVJVUAPUBLAOHAJVBUAZ"
  keyword = "isyah"
